...
export default function Home() {
  ...
  const handleDownload = async () => {
    const fileUrl = "/Ukshati_User_Manual.pdf"; // Change to your API or file path
    ...
    link.download = "UserManual.pdf"; // Set the downloaded file name
...
.botao:hover::before {
  ...
  border-radius: 50%;
  transform: translate(-50%, -50%) rotate(0deg); /* Adjust for exact centering */
