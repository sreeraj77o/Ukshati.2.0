    ...
    <div className="bg-gradient-to-r from-gray-800 to-gray-900 py-8 px-6 w-full mx-auto rounded-xl shadow-2xl border border-white/10 relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-2">
        <div className="flex items-center justify-center space-x-3">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent text-3xl font-bold text-blue-400 mb-2 flex items-center justify-center gap-2">
          <svg 
