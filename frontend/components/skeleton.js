  ...
  <>
    {Array(count)
      ...
      .map((_, index) => (
        <div
          key={index}
          className="h-64 rounded-xl overflow-hidden shadow-lg animate-pulse bg-gradient-to-r from-gray-800 to-gray-700"
        >
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 mb-6">
    {Array(count)
      ...
      .map((_, index) => (
        <div
          key={index}
          className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl p-5 flex flex-col animate-pulse shadow-lg border border-white/10"
        >
  ...
  <div className="space-y-3">
    {Array(count)
      ...
      .map((_, index) => (
        <div
          key={index}
          className="bg-gray-800 rounded-xl p-4 animate-pulse border border-white/5"
        >
          <div className="flex items-center justify-between">
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-pulse">
    {Array(3)
      ...
      .map((_, index) => (
        <div
          key={index}
          className="bg-black rounded-xl p-4 shadow-lg border border-gray-700 h-64"
        >
