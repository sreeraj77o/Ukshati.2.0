    ...
    <FaTimes className="w-5 h-5" />
        ...
        <div className="py-4">
          <nav className="px-4 space-y-1">
            ...
            <Link href="/purchase-order/home" className="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 transition-all group">
              <FaFileInvoice className="w-5 h-5 mr-3 text-cyan-400 group-hover:text-white transition-colors" />
              <span className="font-medium">Purchase Order</span>
            </Link>
          </nav>
        </div>
