  ...
  const fetchOrderData = useCallback(async () => {
    ...
    try {
      ...
      if (vendorsRes.ok && projectsRes.ok) {
        ...
        const foundVendor = vendorsData.find(
          v => v.id === orderData.order.vendor_id
        );
        const foundProject = projectsData.find(
          p =>
            p.id === orderData.order.project_id ||
            p.pid === orderData.order.project_id
        );
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span
                className={`px-3 py-1 text-sm rounded-full ${getStatusBadgeClass(order.status)}`}
              >
          ...
          <div className="mb-8 bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            ...
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <p className="text-gray-600 mb-4">
                PDF preview is not available in this view. Click &quot;Download
                PDF&quot; to generate and view the full PDF document.
              </p>
              <button
                onClick={handleDownloadPDF}
          ...
          <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span>
                  {order.order_date || order.created_at?.split('T')[0] || 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {project?.name || project?.pname || 'Unknown Project'}
                </span>
              </div>
              <div className="flex justify-between">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-700/50 text-left">
                  <th className="px-4 py-3 text-sm font-medium text-gray-300 uppercase">
                    Item
                  </th>
                  <th className="px-4 py-3 text-sm font-medium text-gray-300 uppercase">
                    Description
                  </th>
                  <th className="px-4 py-3 text-sm font-medium text-gray-300 uppercase text-right">
                    Qty
                  </th>
                  <th className="px-4 py-3 text-sm font-medium text-gray-300 uppercase text-right">
                    Unit
