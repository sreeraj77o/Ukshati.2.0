...
export default function PurchaseReports() {
  ...
  const generatePDF = () => {
    try {
      ...
      doc.save(
        `Purchase_Report_${dateRange.startDate}_to_${dateRange.endDate}.pdf`
      );
    } catch (error) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              >
                ...
                <p className="text-3xl font-bold mt-2">
                  {(reportData.totalSpend / 100000).toFixed(2)}L
                </p>
              ...
              >
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Avg. {(reportData.avgOrderValue / 1000).toFixed(1)}K per order
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-3xl font-bold mt-2">
                  {reportData.topVendors[0]?.name || 'N/A'}
                </p>
                <p className="text-sm text-gray-400 mt-1">
                  {reportData.topVendors[0]
                    ? (reportData.topVendors[0].spend / 100000).toFixed(2)
                    : 0}
                  L total spend
                </p>
              </motion.div>
