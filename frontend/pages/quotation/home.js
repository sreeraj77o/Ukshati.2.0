...
import { FaPlus, FaEye ,FaMoneyBillWave } from "react-icons/fa";
...
export default function Home() {
  ...
  const quotationCards = [
    ...
    },
    {
      id: 3,
      title: "Manage Rates",
      Icon: FaMoneyBillWave, // Using a money icon from react-icons/fa
      colors: ["#1e40af", "#3b82f6", "#93c5fd", "#3b82f6", "#1e40af"], // Blue gradient
      route: "/quotation/RatesManagement",
      image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
